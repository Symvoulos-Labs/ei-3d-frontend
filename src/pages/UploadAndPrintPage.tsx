...
const UploadAndPrintPage = () => {
  return (
    <div className="space-y-10 divide-y divide-gray-900/10">
      <div className="grid grid-cols-1 gap-x-8 gap-y-8 pt-10 md:grid-cols-3">
        <div className="px-4 sm:px-0">
          <h2 className="text-base font-semibold leading-7 text-gray-900">Upload and Print</h2>
          ...
          <div className="px-4 py-6 sm:p-8">
            <div className="grid max-w-2xl grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
              ...
              <div className="sm:col-span-2 sm:col-start-1">
                <label htmlFor="infill" className="block text-sm font-medium leading-6 text-gray-900">
                  Infill
                </label>
                <div className="mt-2">
                  <input
              ...
              <div className="sm:col-span-2">
                <label htmlFor="layer-height" className="block text-sm font-medium leading-6 text-gray-900">
                  Layer Height
                </label>
                <div className="mt-2">
                  <input
...
export default UploadAndPrintPage;
