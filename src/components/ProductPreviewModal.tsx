...
const ProductPreviewModal = ({ product, open, onClose }: ProductPreviewModalProps) => {
                    ...
                    <div className="sm:col-span-8 lg:col-span-7">
                      ...
                      <section aria-labelledby="information-heading" className="mt-2">
                        ...
                        <div className="mt-6">
                          ...
                          <div className="flex items-center">
                            ...
                            <a href="#" className="ml-3 text-sm font-medium text-cyan-600 hover:text-cyan-500">
                      ...
                      <section aria-labelledby="options-heading" className="mt-10">
                        ...
                        <p className="mt-6 text-center">
                          <Link to={`/products/${product.id}`} className="text-sm font-medium text-cyan-600 hover:text-cyan-500">
                            View full details
                          </Link>
                        </p>
                      </section>
